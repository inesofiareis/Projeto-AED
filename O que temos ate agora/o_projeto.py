...
def Pessoais():
    ...
    painel1=LabelFrame(window,text='Pessoais',fg='#ea8c5c', font=('Arial',12), width=350, height=300, relief=SUNKEN)
    painel1.place(x=410,y=95)

#-----------------------//------------------------#     
def Profissionais():

    painel1=LabelFrame(window,text='Profissionais',fg='#ea8c5c', font=('Arial',12), width=350, height=300, relief=SUNKEN)
    painel1.place(x=410,y=95)

#-----------------------//------------------------# 
def Projetos():

    painel1=LabelFrame(window,text='Projetos',fg='#ea8c5c', font=('Arial',12), width=350, height=300, relief=SUNKEN)
    painel1.place(x=410,y=95)
    



# Inês - definir as funções e atribuir aos respetivos botões
...
# Inês - Caixa com a lista de tarefas 
...
# Inês - Caixa com botões de criar, editar ou remover 
